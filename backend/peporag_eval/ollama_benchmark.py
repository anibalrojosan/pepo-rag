"""Streamed Ollama /api/generate benchmark: TTFT, TPS, and JSON aggregates."""
...
from peporag_eval.paths import benchmark_results_path
...
def main() -> None:
    ...
    output_file = benchmark_results_path()
